...
while continue_1=='y' or continue_1=='Y':
    ...
    if choice==1:
        ...
        try:
            file=open(f"scripts/pandas_files/csvfiles/{file_name}","a")
        ...
        if os.path.exists(f"scripts/pandas_files/csvfiles/{file_name}"):
            print("file exist")
        else:
        ...
        if os.path.exists(f"scripts/pandas_files/csvfiles/{file_name}"):
            os.remove(f"scripts/pandas_files/csvfiles/{file_name}")
        else:
            print("file does not exist")
    elif choice==7:
