...
credentials = ServiceAccountCredentials.from_json_keyfile_name('analytics-329707-cc4a4b4967b5.json', ['https://www.googleapis.com/auth/analytics.readonly'])
...
response = service.reports().batchGet(
    body={
        'reportRequests': [
            {
                'viewId': '253803495', #Add View ID from GA
